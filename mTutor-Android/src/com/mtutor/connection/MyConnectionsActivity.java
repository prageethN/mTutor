...
public class MyConnectionsActivity extends DashboardActivity {

	ListView lvMyConnection;
	ArrayList<ItemDetails> itemMyConnection;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_myconnections);
...
webServiceCaller = new WebServiceCaller();
		...
		itemMyConnection = getMyConnectionList();
		lvMyConnection = (ListView) findViewById(R.id.lvMyConnection);
		lvMyConnection.setAdapter(new ConnectionItemListBaseAdapter(this,
				itemMyConnection));
		lvMyConnection.setOnItemClickListener(new OnItemClickListener() {
			@Override
			public void onItemClick(AdapterView<?> a, View v, int position,
					long id) {
				Object o = lvMyConnection.getItemAtPosition(position);
	...
	private ArrayList<ItemDetails> getMyConnectionList() {
		...
		txtResultCount.setText(+resultList.size()+" Connections");
		}
		/*ItemDetails item_details = new ItemDetails();
	...
	void deleteRow(String rowText, int position) {
		...
		alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int whichButton) {
				...
				itemMyConnection.remove(positionIndex);
				lvMyConnection.setAdapter(new ConnectionItemListBaseAdapter(
						MyConnectionsActivity.this, itemMyConnection));
			}
		});
